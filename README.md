# 04 clinical risk modeling interpretability bias
...
## MVP Progress
- Added demographic parity gap metric for bias checks.
- Added SHAP-style feature ranking helper.
- Added tests for fairness and interpretability utilities.
